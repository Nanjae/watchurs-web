...
const IntroUpperHeaderLogoIcon = styled(Link)`
  background-image: url(${(props) => props.url});
  background-size: cover;
  width: 60px;
  height: 60px;
...
const IntroUpperHeaderTitleText = styled(Link)`
  font-size: 18px;
  font-weight: 700;
  letter-spacing: 3px;
...
const IntroMainContentIconText = styled.div`
  color: ${(props) => props.theme.fontMainColor};
  font-weight: 400;
  transition: color 0.3s;
`;
                ...
                <IntroUpperHeaderDiv>
                  <IntroUpperHeaderTitleDiv>
                    <IntroUpperHeaderLogoIcon
                      ...
                      url={logo_watchurs}
                    />
                    <IntroUpperHeaderTitleText to={`/home`}>
                      WATCHURS
                  ...
                  <IntroUpperHeaderIconDiv>
                    <IntroUpperHeaderIcon url={icon_facebook} />
                    <IntroUpperHeaderIcon url={icon_instagram} />
                    <IntroUpperHeaderIcon url={icon_twitter} />
                  </IntroUpperHeaderIconDiv>
                </IntroUpperHeaderDiv>
              </IntroUpperLeftDiv>
              <IntroUpperCenterDiv>
                ...
                <IntroMainDiv>
                  <IntroMainContentDiv>
                    ...
                    <IntroMainContentTextDiv>
                      ...
                      <IntroMainContentTextMainBox>
                        It features some modern and classic elements in the
                        decor.
                      </IntroMainContentTextMainBox>
                    ...
                    <IntroMainSwiperInner>
                      ...
                      >
                        ...
                        >
                          ...
                          <IntroMainSwiperImageOpacity
                            style={
                              swiperImageEnter === 4 ? { opacity: 0.3 } : null
                            }
                          />
                        </IntroMainSwiperImageBox>
                      </Swiper>
