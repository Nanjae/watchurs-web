...
export default withRouter(({ loading, data }) => {
  ...
  if (!loading && data && data.seeOneBroadcaster) {
    ...
    data.seeOneBroadcaster[0].bSummoner[0].sDetail.map((detail, index) => {
      if (detail.dLane <= 5) {
    ...
    data.seeOneBroadcaster[0].bSummoner[0].sDetail.map(detail => {
                ...
                <InfoMainBox>
                  ...
                  <SummonerInfoDiv>
                    <SummonerInfoBox>
                      <SummonerAvatarDiv>
                        <SummonerAvatar
                          url={data.seeOneBroadcaster[0].bSummoner[0].sAvatar}
                        >
                    ...
                    <SummonerTierDiv>
                      <SummonerTierBox>
                        ...
                        <TierBox>
                          ...
                          <PointsText>
                            ({data.seeOneBroadcaster[0].bSummoner[0].sPoints}
                            LP)
                          </PointsText>
                        </TierBox>
                      </SummonerTierBox>
                    ...
                    <SummonerWinRateDiv>
                          ...
                          data={[
                            {
                              ...
                              title: "승",
                              value:
                                data.seeOneBroadcaster[0].bSummoner[0].sWins
                            },
                            {
                              color: Theme.lossColor,
                              title: "패",
                              value:
                                data.seeOneBroadcaster[0].bSummoner[0].sLosses
                            }
                          ]}
                          label={({ data }) =>
                      ...
                      <SummonerWinLossDiv>
                        <WinLossBox>
                          ...
                          <WinsText>
                            {data.seeOneBroadcaster[0].bSummoner[0].sWins}승
                          </WinsText>
                          <LossesText>
                            {data.seeOneBroadcaster[0].bSummoner[0].sLosses}패
                          </LossesText>
                        </WinLossBox>
                      </SummonerWinLossDiv>
                    </SummonerWinRateDiv>
                          ...
                          <ReactMinimalPieChart
                            ...
                            data={[
                              ...
                              },
                              {
                                color: Theme.lossColor,
                                title: "패",
                                value: detailWins.filter(x => x === "Fail")
                                  .length
                              }
                            ]}
                            label={({ data }) =>
                        ...
                        data={[
                          {
                            color: Theme.winColor,
                            title: "승",
                            value: data.seeOneBroadcaster[0].bSummoner[0].sWins
                          },
                          {
                            color: Theme.lossColor,
                            title: "패",
